...
public class ScreenMaker {
    ...
    private void fetchComponents(@NonNull final String screenName, @NonNull final Context context, @NonNull final ArrayList<String> componentsKeys) {
        ...
        Cursor cachedComponents = context.getContentResolver().query(DUSContracts.buildFetchContentsUri(screenName), null, DUSContracts.getComponentsQuery(componentsKeys.size()), componentsKeys.toArray(new String[0]), null);
    ...
    @NonNull
    public String refreshUpdateGraph(@NonNull Context context, boolean shouldRetry) {
