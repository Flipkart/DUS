...
public class ComponentDownloader {
    ...
    public void addToDownloadQueue(@NonNull final DownloadJob downloadJob) {
        ...
        mNetworkInterface.getResponseString(new ArrayList<>(downloadList), new ResponseInterface<HashMap<String, Object>>() {
            @Override
            public void OnSuccess(@NonNull HashMap<String, Object> networkResponse) {
                    ...
                    for (Map.Entry<String, Object> entry :
                        ...
                        if (entry != null && entry.getValue() != null && entry.getKey() != null) {
                            ...
                            for (DownloadJob callbackInterface :
                                    callbackList) {
                                callbackInterface.onSuccess(entry.getKey(), entry.getValue().toString());
                            }
                        }
                    }
